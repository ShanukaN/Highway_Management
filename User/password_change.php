        ...
        <div class="card" style="margin: 50px 50px;">
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <center>
                        <button type="submit" class="btn btn-success" name="password_update"
                            style="color: black; font-weight: bold;">Update Password</button>

                        <a href="login.php" class="btn btn-success" style="color: black; font-weight: bold;">Back</a>
                    </center>
            ...
            if(!empty($email) && !empty($new_password) && !empty($confirm_password))
            {
                ...
                if(mysqli_num_rows($check_token_run)>0)
                {
                    if($new_password == $confirm_password)
                    {
                        ...
                        $update_password = "UPDATE users SET password='$password1' WHERE token='$token' LIMIT 1";
