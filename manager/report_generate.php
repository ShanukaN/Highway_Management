...
if(isset($_POST['report'])){
    ...
    $query = "SELECT entrance.key,users.f_name,users.v_number,entrance.entrance,entrance.exit,entrance.price,entrance.speed,entrance.dis,entrance.ent_date,entrance.ent_time,entrance.exit_date,entrance.exit_time FROM entrance INNER JOIN users ON entrance.key =users.nic  WHERE ent_date BETWEEN '$start_date' AND '$end_date'";
